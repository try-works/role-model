...
Outputs:
- `/.recursive/run/05-router-runtime-provider-accounts-sqlite-memory/00-worktree.md`
...
- Preferred worktree location: `.worktrees/05-router-runtime-provider-accounts-sqlite-memory/`
