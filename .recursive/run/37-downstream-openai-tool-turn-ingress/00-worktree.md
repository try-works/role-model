...
Outputs:
- `/.recursive/run/37-downstream-openai-tool-turn-ingress/00-worktree.md`
...
- Preferred worktree location: `.worktrees/37-downstream-openai-tool-turn-ingress/`
...
- Base commit: `d5a92241c40204cc4f8ba17d6f3bd9973da4b67c`

## Diff Basis For Later Audits

- Baseline type: `local commit`
- Baseline reference: `d5a92241c40204cc4f8ba17d6f3bd9973da4b67c`
- Comparison reference: `working-tree`
- Normalized baseline: `d5a92241c40204cc4f8ba17d6f3bd9973da4b67c`
- Normalized comparison: `working-tree`
- Normalized diff command: `git diff --name-only d5a92241c40204cc4f8ba17d6f3bd9973da4b67c`
- Base branch: `main`
- Worktree branch: `main`
