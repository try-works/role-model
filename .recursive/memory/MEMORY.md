...
- `skills/issues/sea-inject-host-join-and-seed-scope.md` — SEA inject unlock needs host join/auto-arm + matching seed scope/verification key (Source-Runs: `85`)
