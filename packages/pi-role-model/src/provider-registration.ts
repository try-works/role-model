...
export function createProviderRegistration(discovery: DownstreamOpenAIDiscovery): ProviderRegistration {
  return mapDiscoveryToProviderConfig(discovery);
}

export function registerRoleModelProvider(pi: Pick<PiExtensionAPI, "registerProvider">, discovery: DownstreamOpenAIDiscovery): ProviderRegistration {
