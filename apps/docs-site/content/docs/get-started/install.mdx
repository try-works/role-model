...
If you want Pi to route through Role-Model, install and launch the runtime first, then install the public Pi
package:
...
For endpoint overrides, remote-runtime trust, auth behavior, and the full command list, read
