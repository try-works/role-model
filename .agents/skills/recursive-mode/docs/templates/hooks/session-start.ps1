...
Write-Output "Optional add-ons:"
Write-Output "  - recursive-benchmark  - Install on demand for paired benchmark runs"
Write-Output ""
...
Write-Output "  4. Install recursive-benchmark only when you explicitly want paired benchmark runs"
Write-Output ""
