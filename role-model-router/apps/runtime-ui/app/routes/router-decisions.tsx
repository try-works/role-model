    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <FactCard
          ...
          detail="Recent request-backed routing decisions in the canonical Router ledger."
          emphasis
        />
        <FactCard
          label="Local"
          value={decisions.filter((decision) => decision.sourceType === "local").length}
          detail="Recent decisions resolved to local execution surfaces."
        />
        <FactCard
          label="Remote"
          value={decisions.filter((decision) => decision.sourceType === "remote").length}
          detail="Recent decisions resolved to remote execution surfaces."
        />
      </div>
