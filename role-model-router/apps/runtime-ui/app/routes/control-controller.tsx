  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <FactCard label="Current source" value={controller.sourceType} detail="The explicit runtime-owned controller assignment stays visible at the top of the page." emphasis />
